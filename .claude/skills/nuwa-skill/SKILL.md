...
按模板将Phase 2结果组装为SKILL.md。

---

### Phase 4: 质量验证

4项测试：已知测试、边缘测试、风格测试、通过标准检查。

---

### Phase 5: 双Agent精炼

并行启动auto-skill-optimizer和skill-creator两个Agent评审优化。

---

## 更新已有Skill

增量更新，只启动Agent 2（对话）+ Agent 5（决策）+ Agent 6（时间线）。
...
- **活人 vs 历史人物**：活人注意时效性，历史人物注意传记偏差
- **主题Skill vs 人物Skill**：主题Skill去掉角色扮演规则，改为框架概览+流派对比
- **中国人物 vs 西方人物**：中文信息源优先B站/小宇宙/权威媒体，排除知乎/微信公众号
- **冷门人物**：信息来源<10条时，降低期望，诚实标注局限
- **蒸馏用户自己**：需要用户提供个人素材，注意自我认知偏差
